...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x11d9f;
...
const char     CRYPTONOTE_NAME[]                             = "Tiberium";
...
const int      RPC_DEFAULT_PORT                              = 18936;
